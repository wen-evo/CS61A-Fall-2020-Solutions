...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    outputs = [dice() for i in range(num_rolls)]
    if 1 in outputs:
        return 1
    else:
        return sum(outputs)
...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    assert isinstance(score, int), "The opponent's score should be int"
    return int(str(pi)[score]) + 3
    # END PROBLEM 2
...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    "*** YOUR CODE HERE ***"
    smaller = player_score if player_score < opponent_score else opponent_score
    if smaller == 0:
        return False
    gcd = 1
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    best_n, best_score = 1, 0
    for n in range(1, 11):
        average_dice = make_averaged(roll_dice, trials_count=trials_count)
        avg_score = average_dice(n, dice)
...
def bacon_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    return 0 if bacon_score >= cutoff else num_rolls  # Replace this statement
    # END PROBLEM 10
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    As suggested by the course:
        1. extra_turn_strategy is a good default strategy to start with.
        2. There's no point in scoring more than 100. Check whether you can win by rolling 0, 1 or 2 dice. If you are in the lead, you might take fewer risks.
        3. Try to force extra turns.
        4. Choose the num_rolls and cutoff arguments carefully.
        5. Take the action that is most likely to win the game.
    """
    # BEGIN PROBLEM 12
    return extra_turn_strategy(score, opponent_score, cutoff=4, num_rolls=4)
    # END PROBLEM 12
